...
plot(datemerge,needfuldata$Sub_metering_1,type="l",xlab ="",ylab ="Energy sub metering")

par(new=TRUE)

plot(datemerge,needfuldata$Sub_metering_2,type="l",col="red",axes=FALSE,xlab ="",ylab ="Energy sub metering",ylim = c(0,30))

par(new=TRUE)

plot(datemerge,needfuldata$Sub_metering_3,axes=FALSE, type="l",col="blue",xlab ="",ylab ="Energy sub metering",ylim = c(0,30))
